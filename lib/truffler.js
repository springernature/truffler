	...
	async.series({
        ...
        openUrl: guardAgainstTimeout(function(next) {
            ...
            state.page.onResourceError = function(resourceError) {
                state.page.reason = resourceError.errorString;
                state.page.reason_url = resourceError.url;
            };
            ...
            state.page.open(url, function(error, status) {
                ...
                if (status !== 'success') {
					return next(new Error('Error opening url "' + state.page.reason_url + "\": " + state.page.reason));
                }
